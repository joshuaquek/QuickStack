...
exports.exampleOne = (app) => { // You can choose to take in parameters here...or not to.
  return (req, res) => { // Remember to always return `(req, res) => {}` here. This allows the `exampleOne(app)` method to use `(req, res) => {}` as a callback.
...
exports.exampleTwo = () => { // You can choose to take in parameters here...or not to.
  return (req, res) => { // Remember to always return `(req, res) => {}` here. This allows the `exampleTwo()` method to use (req, res) => {} as a callback.
