...
const microserviceFolderName = process.env.MICROSERVICE_FOLDER_NAME ? `/${process.env.MICROSERVICE_FOLDER_NAME}` : ''
...
const apiRoutes = require(`../api${microserviceFolderName}`) // API routes to be exposed
